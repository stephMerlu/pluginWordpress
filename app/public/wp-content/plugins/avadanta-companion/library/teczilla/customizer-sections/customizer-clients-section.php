...
//Clients Section
		...
		class Avadanta_clients__section_upgrade extends WP_Customize_Control {
			public function render_content() { ?>
				<a href="<?php echo esc_url( 'https://avadantathemes.com/product/teczilla-pro/' ); ?>" target="_blank"><h3 class="customizer_avadantaclients_upgrade_section" style="display: none;">
