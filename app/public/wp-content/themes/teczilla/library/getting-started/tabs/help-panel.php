...
<div id="help-panel" class="panel-left visible">
    <div class="panel-aside">
        ...
        <a class="button button-primary" href="<?php echo esc_url( 'https://www.avadantathemes.com/demo/teczilla-pro/' ); ?>" title="<?php esc_attr_e( 'Visit the Demo', 'teczilla' ); ?>" target="_blank">
    ...
    <div class="panel-aside">
        ...
        <a class="button button-primary" href="<?php echo esc_url( 'https://avadantathemes.com/docs/introduction-8/' ); ?>" title="<?php esc_attr_e( 'Visit the Documentation', 'teczilla' ); ?>" target="_blank">
