                ...
                <div class="container">
                    <div class="row y-middle">
                        <div class="col-lg-12">
                            ...
                            <p>
                            <?php
                            printf( __( 'Proudly powered by', 'teczilla-portfolio' ) );
                            ?>

                            <a href="<?php echo esc_url( __( 'https://wordpress.org/', 'teczilla-portfolio' ) ); ?>" class="imprint">
                            	
							<?php
                            printf( __( 'WordPress', 'teczilla-portfolio' ) );
                            ?>
                            </a>
